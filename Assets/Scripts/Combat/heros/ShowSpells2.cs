...
public class ShowSpells2 : MonoBehaviour
{
    ...
    void OnMouseOver()
    {
        ...
        GameObject.Find("Spell1").GetComponent<SpriteRenderer>().sprite = Resources.Load<Sprite>("Sprites/Combat/Characters/Spells/" + _heros[1].Spells[0].Name);
        GameObject.Find("Spell2").GetComponent<SpriteRenderer>().sprite = Resources.Load<Sprite>("Sprites/Combat/Characters/Spells/" + _heros[1].Spells[1].Name);
